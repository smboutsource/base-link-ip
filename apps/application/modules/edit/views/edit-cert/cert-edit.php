			...
			<div class="card mb-4">
				<div class="card-header">
					<div class="d-flex flex-wrap justify-content-between align-items-center">
						<h5 class="card-title m-0">SSL Cert Validation</h5>
						<button id="btn-upload-app-serverdata" class="btn btn-sm btn-primary" type="button" data-pem-modals="<?= base_url('edit/server/pem');?>">
							<i class="fas fa-fw fa-upload"></i> Upload Pem Certificate
						</button>
					</div>
				</div>
				<div class="card-body">
